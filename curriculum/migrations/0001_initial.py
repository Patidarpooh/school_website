    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(blank=True, null=True)),
                ('image', models.ImageField(blank=True, upload_to=curriculum.models.save_subject_image, verbose_name='Subject_Image')),
                ('description', models.TextField(blank=True, max_length=500)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(blank=True, null=True)),
                ('video', models.FileField(blank=True, upload_to=curriculum.models.save_lesson_files, verbose_name='video')),
                ...
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lesson', to='curriculum.subject')),
            ],
            options={
                'ordering': ['position'],
            },
